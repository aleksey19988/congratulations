    ...
    <div class="container mx-auto">
        ...
        <div class="section-header-container flex flex-col items-center py-16">
            ...
            <a href="{{ route('positions.create') }}"
               class="py-1 flex justify-center w-9/12 lg:w-3/12 mt-3 bg-green-500 rounded-3xl text-xl lg:text-2xl hover:scale-105 transition-all">Добавить должность</a>
        </div>
        @if(session('message'))
        ...
        @if($positions->count())
            ...
            <div class="">
                <div class="bg-slate-700 rounded-3xl grid grid-cols-3 lg:grid-cols-6 py-3 my-3">
                    ...
                    <div
                        class="lg:col-span-2 hidden lg:flex lg:items-center lg:justify-center">
                        ...
                        <div class="lg:col-start-6 flex items-center justify-evenly">
                            <a href="{{ route('positions.show', $position->id) }}"
                               class="flex justify-center items-center w-2/5 p-1 py-2 bg-slate-950 rounded-3xl hover:scale-105 transition-all">
                                <img src="{{ asset('icons/profile.svg') }}" alt="Подробнее" class="xl:h-5">
                            </a>
                            <form action="{{ route('positions.destroy', $position->id) }}" method="post"
                                ...
                                <button type="submit" class="w-full hover:scale-105 transition-all">
                                    <a href=""
                                       class="flex justify-center items-center py-2 bg-red-500 rounded-3xl">
