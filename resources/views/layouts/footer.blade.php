<div class="footer container p-4 bg-white dark:bg-slate-700 mt-5 rounded-3xl px-16 flex justify-between fixed bottom-5 w-11/12 z-50 shadow-2xl dark:shadow-none">
